...
public class Order_Confirmation_bank {
	...
	public void confirm(WebDriver driver) throws IOException {
		...
		try {
			...
			// Order Confirmation
			WebElement Message = driver.findElement(By.xpath("//*[@id=\"center_column\"]/div/p/strong"));
			System.out.println(Message.getText());
			assertTrue(Message.getText().contains("Your order on My Store is complete."));

		} catch (InterruptedException ex) {
			Logger.getLogger(Order_Confirmation_bank.class.getName()).log(Level.SEVERE, null, ex);
		}

...
public class Add_an_element_to_cart_pay_check {
	...
	public void Adding_an_element_to_cart_Edge(String Email, String Password) throws IOException {
		...
		Payment_Pay_by_check pay = new Payment_Pay_by_check();
		pay.payment(driver);

		Order_Summary sum = new Order_Summary();
		sum.order(driver);

		Order_Confirmation_check conf = new Order_Confirmation_check();
		conf.confirm(driver);
